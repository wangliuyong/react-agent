import { r as reactExports, g as getDefaultExportFromCjs, R as ReactExports, j as jsxRuntimeExports } from "./vendor-xyflow-ByVkQ6-f.js";
import { g as _toConsumableArray, c as classNames, b0 as Trigger, a as _defineProperty, e as _objectSpread2, _ as _slicedToArray, f as _typeof, b1 as useEvent, u as useMergedState, b2 as wrapperRaf, w as warningOnce, b3 as useLayoutUpdateEffect, b4 as useLayoutEffect, d as _extends, b5 as isVisible, b6 as RefResizeObserver, p as pickAttrs, b as _objectWithoutProperties, b7 as _createClass, b8 as _classCallCheck, x as omit, b9 as ForwardOverflow, m as merge, ba as genOverflowStyle, bb as getMultipleSelectorUnit, j as unit, bc as FastColor, bd as initComponentToken, be as getArrowToken, bf as genOutlinedStyle, bg as genUnderlinedStyle, bh as genFilledStyle, bi as genBorderlessStyle, i as genStyleHooks, bj as initInputToken, bk as genCompactItemStyle, r as resetComponent, bl as slideUpOut, bm as slideDownOut, bn as slideUpIn, bo as slideDownIn, bp as textEllipsis, bq as genRoundedArrow, br as genPlaceholderStyle, bs as initSlideMotion, bt as initMoveMotion, I as Icon$1, o as useComponentConfig, bu as useIcons$1, bv as RefIcon$4, E as Button, h as ConfigContext, bw as useCompactItemContext, bx as useVariant, by as useCSSVarCls, q as useSize, bz as DisabledContext, bA as FormItemInputContext, bB as useLocale$1, bC as locale, bD as useZIndex, bE as ContextIsolator, bF as getStatusClassNames, bG as getMergedStatus, bH as genPurePanel, bI as useScheduleStore, aL as usePublishStore, aM as useWorkflowsStore, aq as useSessionStore, aj as useAppStore, Y as useSettingsStore, aN as useChannelsStore, aP as queryEnabledNotifyChannelsFromStore, aI as FeaturePageHeader, a6 as Space, aK as RefIcon$5, D as appMessage, bJ as createEmptyScheduledTask, at as RefIcon$6, ar as Segmented, as as shellStyles, ah as Input$1, aC as RefIcon$7, aw as Empty, S as Spin, a5 as Tooltip, al as RefIcon$9, aU as RefIcon$a, aA as Popconfirm, aB as RefIcon$b, bK as formatNextRunAt, bL as formatScheduledTaskRunCount, ax as Tag, aW as DB_THEME, bM as queryRunInBackground, af as Form, ag as Modal, bN as SCHEDULE_REPEAT_OPTIONS, ab as Select, bO as WEEKDAY_OPTIONS, a_ as Switch, bP as formatScheduleSummary, bQ as queryScheduleTimesOfDay, bR as normalizeScheduleActiveRange, bS as normalizeScheduleTimesOfDay } from "./index-BQnnWLUu.js";
...
import { R as RefIcon$8 } from "./CaretRightOutlined-B57Sb4cd.js";
import { R as RefIcon$c } from "./MinusCircleOutlined-7FKBZe7B.js";
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Form.List,
                {
                  ...
                  children: (fields, { add, remove }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.timesOfDayList, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.timesOfDayListWrap, children: fields.map(({ key, name, ...restField }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { align: "baseline", className: styles.timesOfDayRow, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Form.Item,
                        {
                          ...restField,
