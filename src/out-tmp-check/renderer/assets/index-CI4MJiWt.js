import { r as reactExports, c as reactDomExports, R as ReactExports, j as jsxRuntimeExports } from "./vendor-xyflow-C3K48oRM.js";
import { aX as wrapperRaf, bM as useForceUpdate, f as _typeof, e as _objectSpread2, w as warningOnce, x as omit, g as _toConsumableArray, t as toArray$1, b as _objectWithoutProperties, I as Icon, d as _extends, aW as useEvent, _ as _slicedToArray, aZ as useLayoutEffect, bN as isEqual, bO as supportRef, bP as useMemo, bQ as get, c as classNames, a as _defineProperty, a$ as RefResizeObserver, a_ as isVisible, bR as fillRef, bS as canUseDom, bT as getDOM, bU as getScrollBarSize, bV as getTargetScrollBarSize, bW as isStyleSupport, p as pickAttrs, bX as List, bY as devUseWarning, u as useMergedState, a3 as RefIcon$i, C as CSSMotion, bZ as _inherits, b_ as _createSuper, b1 as _classCallCheck, b$ as _assertThisInitialized, K as KeyCode, b0 as _createClass, i as genStyleHooks, k as genCollapseMotion, m as merge, r as resetComponent, c0 as Keyframe, j as unit, c1 as genFocusOutline, ac as RefIcon$j, s as cloneElement, h as ConfigContext, bs as DisabledContext, v as initCollapseMotion, c2 as useToken, c3 as Input, av as RefIcon$m, B as Button, c4 as mergeProps, ap as Empty, $ as Tooltip, bi as textEllipsis, c5 as operationUnit, c6 as clearFix, b5 as FastColor, c7 as useBreakpoint, c8 as localeValues, q as useSize, br as useCSSVarCls, c9 as DefaultRenderEmpty, S as Spin, ca as ConfigProvider, a7 as Form, a8 as Modal, a9 as Input$1, cb as queryNewCustomProviderId, cc as queryProviderOption, cd as queryResolvedModelOptionsForProvider, Y as queryModelOptionDisplayLabel, ce as RefIcon$o, a4 as Select, aD as RefIcon$q, cf as queryModelOptions, ao as Drawer, cg as Tabs, T as Typography, R as RefIcon$r, aT as Switch, X as queryModelCategory, ch as queryModelSupportsThinking, aq as Tag, ci as PROVIDER_MODEL_CATEGORY_PRESETS, z as appMessage, cj as queryNewProviderModelRecordId, a0 as Space, ck as queryAllProviderOptions, cl as queryProviderCredentialsFromSettings, cm as queryAlignConnectionsToActiveProvider, P as useSettingsStore, Q as queryGeneralChatModelConnection, cn as queryProviderModelCatalogForProvider, aM as cardStyles, am as RefIcon$s, co as queryIsCustomModelProvider, ae as Card, aN as RefIcon$t, au as RefIcon$u, af as RefIcon$v, cp as TypedInputNumber, cq as queryRemoveCustomProvider, cr as DEFAULT_ROLE_PROMPT_OVERRIDES, cs as queryIsChatPipelineRole, J as queryToolLabel, ct as querySyncConnectionsProviderCredentials, cu as DEFAULT_CONNECTION, ak as Segmented, ay as RefIcon$y, at as Popconfirm, O as RefIcon$A, D as queryLocalImageDataUrl, E as queryLocalMediaUrl, aB as FeaturePageHeader, cv as RefIcon$C, al as shellStyles, cw as ChannelsPanel } from "./index-D2SMd1bE.js";
import { g as addEventListenerWrap, e as RefIcon$k, f as RefIcon$p, R as RefIcon$w, d as RefIcon$x, a as Alert, A as ArtifactFileActions, c as RefIcon$z, b as RefIcon$B, I as Image } from "./ArtifactFileActions-DRA9KDLl.js";
import { C as Checkbox, g as getStyle } from "./index-BMGYYAHO.js";
import { D as Dropdown, M as Menu, O as OverrideProvider } from "./index-BDNh-rpT.js";
import { R as Radio } from "./index-DL0mINbx.js";
import { P as Pagination } from "./Pagination-CMcAavWd.js";
import { R as RefIcon$l } from "./FolderOpenOutlined-CpyBDLdr.js";
import { R as RefIcon$n } from "./CaretDownOutlined-T4m3zqW8.js";
...
import { R as RefIcon$D } from "./RocketOutlined-jqRlO1q1.js";
...
function AddModelProviderModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Modal,
    {
      ...
      width: 480,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$a.lead, children: "自定义供应商按 OpenAI 兼容协议接入，添加后可在供应商下拉中选用，不会自动切换当前供应商。" }),
...
function EditProviderCredentialsModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Modal,
    {
      ...
      width: 520,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$9.providerBadge, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$o, {}),
          providerLabel
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$9.lead, children: "密钥仅写入本机 Electron userData，不参与任何遥测或同步。" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { form: form2, layout: "vertical", className: styles$9.form, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Form.Item,
            {
              label: "API Key",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Form.Item,
            {
              label: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$9.modelLabelRow, children: [
                "默认模型",
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
...
function ProviderModelsMaintenanceDrawer({
  ...
  const postAdoptToManual = (row) => {
    ...
    const next = {
      ...
      modelId: row.modelId,
      displayName: row.displayName !== row.modelId ? row.displayName : void 0,
    ...
    appMessage.success(`已登记「${row.displayName}」到本机`);
  };
  ...
  const manualColumns = [
    {
      ...
      key: "modelId",
      width: 160,
      render: (value) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$8.modelIdCell, children: value })
    },
    {
      title: "名称",
    ...
    },
    {
      ...
      key: "flags",
      width: 120,
      render: (_value, row) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.metaTags, children: [
        row.supportsThinking ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { color: "blue", children: "思考" }) : null,
        row.supportsVision ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { color: "purple", children: "视觉" }) : null,
        !row.supportsThinking && !row.supportsVision ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text$6, { type: "secondary", children: "—" }) : null
      ] })
    },
    {
      title: "操作",
      ...
      width: 108,
      fixed: "right",
      render: (_value, row) => row.record ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { size: 4, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "link", size: "small", onClick: () => openEdit(row.record), children: "编辑" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "link", size: "small", danger: true, onClick: () => handleDelete(row.record), children: "删除" })
      ] }) : null
    }
  ];
  ...
  const queryTabLabel = (key, count, label) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$8.tabLabel, children: [
    label,
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$8.tabCount, children: count })
  ] });
  const renderTable = (rows, columns, empty2) => {
    if (rows.length === 0) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.emptyBlock, children: empty2 });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.tableWrap, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ForwardTable,
      {
        rowKey: "key",
        size: "small",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Drawer,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$8.lead, children: "本机登记可增删改；本地兜底为应用内置列表；平台拉取来自供应商 /models。保存设置后本机登记会与平台列表合并供下拉选用。" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tabs,
            {
              activeKey: activeTab,
              ...
              items: [
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.tabPane, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.paneHint, children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.tableArea, ref: tableHostRef, children: renderTable(
                      manualRows,
                      manualColumns,
                ...
                },
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.tabPane, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.paneHint, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "应用内置静态列表，平台不可达时下拉会回退到此处。只读，可将条目登记到本机以补充元数据。" }) }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.tableArea, ref: tableHostRef, children: renderTable(
                      fallbackRows,
                      readonlyColumns,
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                },
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.tabPane, children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.paneHint, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.paneHintActions, children: [
                        platformRows.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            Input$1,
                            {
                              ...
                              className: styles$8.platformSearch
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(Text$6, { type: "secondary", className: styles$8.platformSearchMeta, children: [
                            filteredPlatformRows.length,
                            " / ",
                            platformRows.length
                          ] })
                    ...
                    platformError ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.errorBanner, children: platformError }) : null,
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$8.tableArea, ref: tableHostRef, children: platformLoading && platformRows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.emptyBlock, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        cancelText: "取消",
        destroyOnHidden: true,
        className: styles$8.editModal,
        width: 480,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { form: form2, layout: "vertical", className: styles$8.form, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Form.Item,
            {
              label: "模型编码",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$8.switchRow, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: styles$8.switchItem, children: [
...
function ModelApiPanel() {
  ...
  const handleConfirmDelete = (providerId, label) => {
    Modal.confirm({
      title: `删除供应商「${label}」？`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.panel, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.toolbar, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.toolbarText, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title$3, { level: 5, className: styles$7.title, children: "模型与API" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Text$5, { type: "secondary", className: styles$7.desc, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardFooter, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  className: styles$7.manageModelsBtn,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.runtimeSection, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.runtimeHeader, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title$3, { level: 5, className: styles$7.title, children: "运行参数" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text$5, { type: "secondary", className: styles$7.desc, children: "Agent 全局行为偏好，与具体供应商无关" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.runtimeGrid, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { variant: "borderless", className: styles$7.runtimeCard, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.runtimeIcon, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$v, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.runtimeContent, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.runtimeTitle, children: "最大工具轮次" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text$5, { type: "secondary", className: styles$7.runtimeDesc, children: "单次任务允许 Agent 连续调用工具的上限" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.runtimeControl, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            TypedInputNumber,
            {
              min: 5,
              max: 100,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { variant: "borderless", className: styles$7.runtimeCard, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.runtimeIcon, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$w, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.runtimeContent, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.runtimeTitle, children: "完全访问" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text$5, { type: "secondary", className: styles$7.runtimeDesc, children: "允许更广泛的本机操作，仅在你信任当前任务时开启" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.runtimeControl, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { checked: fullAccess, onChange: setFullAccess }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { variant: "borderless", className: styles$7.runtimeCard, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.runtimeIcon, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$x, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.runtimeContent, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.runtimeTitle, children: "思考模式" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text$5, { type: "secondary", className: styles$7.runtimeDesc, children: "允许部分模型输出 thinking / reasoning 过程（DeepSeek 可能影响多轮工具调用）" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$7.runtimeControl, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { checked: thinkingEnabled, onChange: setThinkingEnabled }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.footerHint, children: [
...
function queryPostCustomAgentRoleId(label, existingIds) {
  ...
  const base = label.trim().toLowerCase().replace(/[^a-z0-9\u4e00-\u9fff]+/g, "_").replace(/^_+|_+$/g, "").slice(0, 32);
...
function AddCustomRoleModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Modal,
    {
      ...
      width: 560,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$6.lead, children: "自定义角色会出现在角色卡片列表中，可由 Supervisor 路由直达（单步执行后结束）。内置角色不可删除。" }),
...
function EditModelConnectionModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Modal,
    {
      ...
      width: 520,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$5.lead, children: "连接凭证继承自「模型与 API」中对应供应商的配置；此处维护名称、模型与能力标签。" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Form.Item,
            {
              ...
              children: [
                ...
                modelHint2 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text$4, { type: "secondary", className: styles$5.modelHint, children: modelHint2 }) : null
              ]
            }
          ),
...
function EditRoleTaskModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Modal,
    {
      ...
      width: 600,
      footer: (_, { OkBtn, CancelBtn }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.footer, children: [
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$4.lead, children: roleDescription }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { form: form2, layout: "vertical", className: styles$4.form, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Form.Item,
            {
              label: "模型连接",
          ...
          canDeleteRole ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Form.Item,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(TextArea, { className: styles$4.promptArea, rows: 6, maxLength: 8e3, showCount: true })
            }
          ) : null,
          canEditTools ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.toolsHeader, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.toolsTitle, children: "工具注入" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { size: 8, children: [
                toolWhitelistCustomized ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$4.customHint, children: "已自定义" }) : null,
...
function ModelConnectionsPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.panel, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.toolbar, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.toolbarText, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title$2, { level: 5, className: styles$3.title, children: "模型连接" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text$3, { type: "secondary", className: styles$3.desc, children: "Agent 按角色自动选型；请在「模型与 API」中配置凭证，点击卡片或编辑按钮维护连接" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { wrap: true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
        ...
        Card,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardBody, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.capabilityRow, children: conn.capabilities.map((cap) => /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: styles$3.capTag, children: queryCapabilityLabel(cap) }, cap)) })
            ] })
          ]
        },
        conn.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.roleSection, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.roleHeader, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title$2, { level: 5, className: styles$3.title, children: "角色 / 任务 → 模型" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text$3, { type: "secondary", className: styles$3.desc, children: "Supervisor 路由到角色后使用对应连接；可添加自定义角色（内置不可删）" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.roleGrid, children: roleTaskCards.map((role, index) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            type: "button",
            className: styles$3.roleCard,
            style: { "--card-index": index },
            onClick: () => setEditingRole(role.value),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.roleCardHead, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Text$3, { className: styles$3.roleLabel, children: role.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$t, { className: styles$3.roleEditIcon, "aria-hidden": true })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Text$3, { type: "secondary", className: styles$3.roleDesc, children: role.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.roleMeta, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$6, { className: styles$3.roleMetaIcon, "aria-hidden": true }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Text$3, { className: styles$3.roleConnection, children: queryConnectionLabel(mappedId) })
              ] }),
              toolSummary ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text$3, { type: "secondary", className: styles$3.roleToolMeta, children: toolSummary }) : null,
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.roleTags, children: [
                !role.builtin ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: styles$3.customPromptTag, children: "自定义角色" }) : null,
                hasOverride ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: styles$3.customPromptTag, children: "已自定义设定" }) : null,
                toolsCustomized ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: styles$3.customPromptTag, children: "已自定义工具" }) : null
              ] })
            ]
          },
          role.value
...
const panel$1 = "_panel_ov7s5_3";
const panelHeader$1 = "_panelHeader_ov7s5_13";
const titleRow$1 = "_titleRow_ov7s5_22";
const title$1 = "_title_ov7s5_22";
const countBadge$1 = "_countBadge_ov7s5_36";
const panelDesc$1 = "_panelDesc_ov7s5_50";
const errorAlert$1 = "_errorAlert_ov7s5_54";
const toolbar$1 = "_toolbar_ov7s5_59";
const searchInput$1 = "_searchInput_ov7s5_67";
const resultCount$1 = "_resultCount_ov7s5_71";
const listScroll$1 = "_listScroll_ov7s5_75";
const empty$1 = "_empty_ov7s5_92";
const injectionList = "_injectionList_ov7s5_102";
const chipWrap = "_chipWrap_ov7s5_108";
const toolChip = "_toolChip_ov7s5_114";
const usageModal = "_usageModal_ov7s5_122";
const usageBody = "_usageBody_ov7s5_127";
const usageMarkdown = "_usageMarkdown_ov7s5_133";
const detailModal = "_detailModal_ov7s5_139";
const detailBody = "_detailBody_ov7s5_144";
const detailMeta = "_detailMeta_ov7s5_150";
const detailId = "_detailId_ov7s5_157";
const sourcePath = "_sourcePath_ov7s5_165";
const detailDesc = "_detailDesc_ov7s5_170";
const detailSection = "_detailSection_ov7s5_177";
const sectionLabel = "_sectionLabel_ov7s5_183";
const codeBlock = "_codeBlock_ov7s5_190";
const styles$2 = {
  panel: panel$1,
...
function ToolsPanel() {
  ...
  const rolesUsingTool = (toolName) => injections.filter((row) => row.mode !== "none" && row.toolNames.includes(toolName)).map((row) => row.role);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.panel, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.panelHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.titleRow, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title$1, { level: 4, className: styles$2.title, children: "Agent 工具" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.countBadge, children: tools.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text$2, { type: "secondary", className: styles$2.panelDesc, children: "查看已注册工具与源码；角色注入可在「模型连接 → 角色卡片」中维护，此处为只读一览" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { wrap: true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Segmented,
    ...
    view === "list" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.toolbar, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Text$2, { type: "secondary", className: styles$2.resultCount, children: [
          filtered.length,
          " / ",
          tools.length,
          " · general 注入 ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.listScroll, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spin, { spinning: loading && tools.length === 0, children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Empty,
        {
          image: Empty.PRESENTED_IMAGE_SIMPLE,
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cardStyles.grid, children: filtered.map((tool, index) => {
        PERMISSION_META[tool.permission];
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.listScroll, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spin, { spinning: loading && injections.length === 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.injectionList, children: injections.map((row, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        variant: "borderless",
        className: cardStyles.card,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardHead, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardTitleBlock, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Text$2, { className: cardStyles.cardTitle, children: ROLE_LABELS[row.role] ?? row.role }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: cardStyles.cardSubtitle, children: row.role })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { size: 6, children: [
              row.customized ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: cardStyles.primaryTag, children: "已自定义" }) : null,
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Tag,
                {
                  className: row.mode === "all" ? cardStyles.primaryTag : row.mode === "none" ? cardStyles.mutedTag : cardStyles.successTag,
                  children: MODE_LABELS[row.mode]
                }
              ),
              row.customized ? /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: cardStyles.mutedTag, children: "已自定义" }) : null,
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.countBadge, children: row.toolNames.length })
            ] })
          ] }),
          row.toolNames.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text$2, { type: "secondary", children: "此角色不挂载任何工具（仅路由）" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.chipWrap, children: row.toolNames.map((name) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tag,
            {
              className: styles$2.toolChip,
              onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        width: 680,
        destroyOnHidden: true,
        className: styles$2.usageModal,
        children: !usageTool ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { description: "未选择工具" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.usageBody, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: styles$2.detailId, children: usageTool.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.usageMarkdown, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkillMarkdown, { source: usageTool.usageGuide }) })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        width: 860,
        destroyOnHidden: true,
        className: styles$2.detailModal,
        children: !detail ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { description: "未选择工具" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.detailBody, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.detailMeta, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: styles$2.detailId, children: detail.name }),
            ...
            detail.source ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Text$2, { type: "secondary", className: styles$2.sourcePath, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Paragraph$1, { className: styles$2.detailDesc, children: detail.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.detailSection, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: styles$2.sectionLabel, children: "注入角色" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.detailSection, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: styles$2.sectionLabel, children: "参数 Schema" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: styles$2.codeBlock, children: JSON.stringify(detail.parameters, null, 2) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.detailSection, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: styles$2.sectionLabel, children: "源码预览" }),
            detail.sourceCode ? /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: styles$2.codeBlock, children: detail.sourceCode }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              Empty,
              {
                image: Empty.PRESENTED_IMAGE_SIMPLE,
...
const panel = "_panel_1ro6a_3";
const panelHeader = "_panelHeader_1ro6a_13";
const titleRow = "_titleRow_1ro6a_32";
const title = "_title_1ro6a_32";
const countBadge = "_countBadge_1ro6a_46";
const panelDesc = "_panelDesc_1ro6a_60";
const errorAlert = "_errorAlert_1ro6a_88";
const toolbar = "_toolbar_1ro6a_93";
const searchInput = "_searchInput_1ro6a_101";
const resultCount = "_resultCount_1ro6a_105";
const listScroll = "_listScroll_1ro6a_111";
const empty = "_empty_1ro6a_130";
const assetIdentity = "_assetIdentity_1ro6a_140";
const assetIcon = "_assetIcon_1ro6a_147";
const assetPath = "_assetPath_1ro6a_167";
const footerActions = "_footerActions_1ro6a_174";
const fileActions = "_fileActions_1ro6a_181";
const iconAction = "_iconAction_1ro6a_187";
const iconActionDanger = "_iconActionDanger_1ro6a_206";
const previewDrawer = "_previewDrawer_1ro6a_211";
const previewWrap = "_previewWrap_1ro6a_215";
const previewMeta = "_previewMeta_1ro6a_222";
const previewPath = "_previewPath_1ro6a_229";
const previewLoading = "_previewLoading_1ro6a_235";
const previewImageWrap = "_previewImageWrap_1ro6a_244";
const previewImage = "_previewImage_1ro6a_244";
const previewMedia = "_previewMedia_1ro6a_260";
const previewAudio = "_previewAudio_1ro6a_267";
const previewFrame = "_previewFrame_1ro6a_271";
const previewText = "_previewText_1ro6a_279";
const previewFallback = "_previewFallback_1ro6a_294";
const previewFallbackIcon = "_previewFallbackIcon_1ro6a_307";
const styles$1 = {
  panel,
  panelHeader,
  titleRow,
...
function AssetPreviewBody({ asset }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.previewLoading, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Spin, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text$1, { type: "secondary", children: "正在加载预览…" })
    ] });
  }
  if (asset.kind === "image" && imageUrl) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.previewImageWrap, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: imageUrl, alt: asset.name, className: styles$1.previewImage }) });
  }
  if (asset.kind === "video" && mediaUrl) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("video", { controls: true, className: styles$1.previewMedia, src: mediaUrl });
  }
  if (asset.kind === "audio" && mediaUrl) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("audio", { controls: true, className: styles$1.previewAudio, src: mediaUrl });
  }
  if (asset.kind === "html" && mediaUrl) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
        className: styles$1.previewFrame,
        title: asset.name,
        src: mediaUrl,
  ...
  if (textContent != null) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: styles$1.previewText, children: textContent });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.previewFallback, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$f, { className: styles$1.previewFallbackIcon }),
...
function AssetsPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.panel, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.panelHeader, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.titleRow, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { level: 4, className: styles$1.title, children: "Agent 资产" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.countBadge, children: assets.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Text$1, { type: "secondary", className: styles$1.panelDesc, children: [
          "查看、预览与维护 Agent 生成的全部本地文件 · 占用 ",
          queryFormatAssetSize(totalSize)
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { wrap: true, children: [
        filtered.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.batchBar, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Checkbox,
            {
          ...
          selectedCount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { wrap: true, size: 8, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Text$1, { type: "secondary", className: styles$1.batchHint, children: [
              "已选 ",
              selectedCount,
              " 项 · ",
    ...
    error ? /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { type: "error", showIcon: true, message: error, className: styles$1.errorAlert }) : null,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.listScroll, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spin, { spinning: loading && assets.length === 0, children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      Empty,
      {
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cardStyles.grid, children: filtered.map((asset, index) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardHead, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.assetIdentity, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${cardStyles.cardIcon} ${styles$1.assetIcon}`, "data-kind": asset.kind, children: KIND_ICON[asset.kind] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardTitleBlock, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardBody, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  type: "secondary",
                  className: `${cardStyles.metaMono} ${styles$1.assetPath}`,
                  ellipsis: { tooltip: asset.path },
                  children: asset.path
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cardStyles.cardFooter, onClick: (e) => e.stopPropagation(), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.footerActions, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "预览", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    type: "text",
                    size: "small",
                    className: styles$1.iconAction,
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon$y, {}),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ArtifactFileActions,
                  {
                    ...
                    iconOnly: true,
                    className: styles$1.fileActions
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Popconfirm,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "删除", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        size: "small",
                        danger: true,
                        className: `${styles$1.iconAction} ${styles$1.iconActionDanger}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Drawer,
      {
        ...
        className: styles$1.previewDrawer,
        destroyOnHidden: true,
        ...
        children: previewAsset ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.previewWrap, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.previewMeta, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text$1, { type: "secondary", className: styles$1.previewPath, copyable: true, children: previewAsset.path })
        ] }) : null
      }
    )
  ] });
...
function SettingsPage() {
  ...
  const tabHint = tab === "model" ? `${providerCount} 个供应商` : tab === "connections" ? `${connectionCount || 1} 条连接` : tab === "app" ? "本机启动偏好" : tab === "channels" ? "发布与通知渠道" : tab === "tools" ? "Agent 工具注册表" : tab === "assets" ? "Agent 产出文件" : "";
