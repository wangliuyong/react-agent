...
import { S as STOCK_RANGE_LABELS } from "./index-BIiC0F5L.js";
import { h as ConfigContext, c as classNames, s as cloneElement, dx as Col, i as genStyleHooks, m as merge, j as unit, r as resetComponent, o as useComponentConfig, q as useSize, ca as mergeProps, g as _toConsumableArray, cd as useBreakpoint, dy as responsiveArray, dz as Row, cf as DefaultRenderEmpty, S as Spin, dA as queryAshareKlineRefresh, D as appMessage, cm as Tabs, ax as Tag, E as Button, am as Card } from "./index-BQnnWLUu.js";
...
import "./useSkillsStore-Bec86d-P.js";
import "./markdown-local-image-BwFTeukk.js";
import "./LazyChatMarkdown-BGGvM4yz.js";
import "./ArtifactFileActions--VhqergO.js";
import "./LeftOutlined-DLcljnsf.js";
import "./FolderOpenOutlined-eU2RptIS.js";
import "./index-BCCKOrpo.js";
import "./ToolOutlined--gas-4iW.js";
import "./CaretRightOutlined-B57Sb4cd.js";
import "./PlayCircleOutlined-y8OhbKwX.js";
import "./index-DdgcjpRF.js";
import "./index-CTeoHogA.js";
import "./MinusCircleOutlined-7FKBZe7B.js";
...
function queryScoreOverallSignal(tradeSignals, trend, prediction2, indicators) {
  let score = 0;
  const reasons = [];
  ...
  if (prediction2.direction === "up") {
    const w = prediction2.confidence >= 55 ? 1.2 : 0.5;
    score += w;
    reasons.push(`预测看涨+${w}`);
  } else if (prediction2.direction === "down") {
    const w = prediction2.confidence >= 55 ? 1.2 : 0.5;
    score -= w;
    reasons.push(`预测看跌-${w}`);
  }
...
function queryBuildSummary(chart2, trend, indicators, prediction2, overallSignal, tradeSignals, scoreReason) {
...
function queryAnalyzeStockChart(chart2) {
  ...
  const scored = queryScoreOverallSignal(tradeSignals, trend, prediction2, indicators);
