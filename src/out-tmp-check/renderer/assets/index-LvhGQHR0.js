import { r as reactExports, j as jsxRuntimeExports, H as Handle, P as Position, u as useNodesState, h as useEdgesState, i as applyNodeChanges, k as applyEdgeChanges, l as addEdge, m as index, B as Background, C as Controls, M as MarkerType } from "./vendor-xyflow-ByVkQ6-f.js";
import { I as Icon, d as _extends, am as Card, aT as cardStyles, T as Typography, ax as Tag, a5 as Tooltip, E as Button, aF as RefIcon$2, aU as RefIcon$3, af as Form, ah as Input, ab as Select, ag as Modal, aw as Empty, aW as DB_THEME, a6 as Space, aA as Popconfirm, aB as RefIcon$4, cK as RefIcon$5, D as appMessage, ak as RefIcon$7, aN as useChannelsStore, aP as queryEnabledNotifyChannelsFromStore, cL as createAgentNode, cM as queryIsReplaceableCollectPrompt, cN as queryDefaultCollectPrompt, a_ as Switch, cO as queryFeishuMsgType, cP as isLeafNode, cQ as postSelectDirectory, cR as createToolNode, cS as createInputNode, cT as createOutputNode, cU as createAwaitNode, cV as createNotifyNode, cW as createParallelNode, cX as createConditionNode, cY as createEmptyNode, av as Drawer, at as RefIcon$8, W as RefIcon$a, aM as useWorkflowsStore, aq as useSessionStore, aj as useAppStore, aI as FeaturePageHeader, aK as RefIcon$b, ar as Segmented, as as shellStyles, aC as RefIcon$c, S as Spin } from "./index-BQnnWLUu.js";
import { R as RefIcon$6 } from "./PlayCircleOutlined-y8OhbKwX.js";
...
import { R as RefIcon$9 } from "./FullscreenOutlined-C5WwOVDO.js";
          ...
          if (j === 0) {
            ...
            for (const prev of sources) {
              edges.push({
                ...
                matchMode: node2.matchMode === "all" ? "all" : void 0
              });
            }
          } else {
            edges.push({
...
function compileXorFromEdges(id, title2, edgesFrom, takeArmChain) {
  ...
  const node2 = {
    ...
    matchMode: edgesFrom.some((e) => e.matchMode === "all") ? "all" : void 0
  };
...
function nodeToFormValues(node2) {
  const collectFromNode = "collectPrompt" in node2 && typeof node2.collectPrompt === "string" ? node2.collectPrompt : void 0;
  const toolNameForDefault = node2.type === "tool" ? node2.toolName : void 0;
  const base = {
    type: node2.type,
    title: node2.title,
    ...
    collectPrompt: collectFromNode?.trim() || (isLeafNode(node2) && node2.type !== "await_user" ? queryDefaultCollectPrompt(node2.type, toolNameForDefault) : void 0)
  };
  if (node2.type === "agent") {
    return {
      ...base,
...
function buildNodeFromValues(values, prev) {
  ...
  const collectPrompt = (values.collectPrompt ?? "").trim() || void 0;
  const withIo = (node22) => ({
    ...node22,
...
function WorkflowNodeEditModal({
  ...
  const collectDefaultsRef = reactExports.useRef({});
  ...
  reactExports.useEffect(() => {
    ...
    const nextTool = type === "tool" ? (toolName ?? "").trim() || void 0 : void 0;
    if (prev.type === type && prev.toolName === nextTool) return;
    const current = form2.getFieldValue("collectPrompt");
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { form: form2, layout: "vertical", style: { marginTop: 12 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Form.Item,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  rows: 4,
                  placeholder: type ? queryDefaultCollectPrompt(type, toolName) : "说明如何取值并写入 context 键"
                }
              )
            }
          ),
        ...
        (type === "condition" || isEditingCondition) && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          branchShape === "switch" && /* @__PURE__ */ jsxRuntimeExports.jsx(Form.List, { name: "cases", children: (fields, { add, remove }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            fields.map(({ key, name, ...restField }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { align: "baseline", style: { display: "flex" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Form.Item,
                {
                  ...restField,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Form.Item, { ...restField, name: [name, "label"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "标签", style: { width: 120 } }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "link", danger: true, onClick: () => remove(name), children: "删除" })
            ] }, key)),
...
function WorkflowEdgeEditModal({
  ...
  const handleOk = async () => {
    try {
      ...
      const matchMode = values.matchAll ? "all" : void 0;
      let when;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { form: form2, layout: "vertical", style: { marginTop: 12 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Typography.Paragraph, { type: "secondary", style: { marginBottom: 0 }, children: "同一节点上：全部无条件多出线 = 并行；带条件 = 条件分支（默认只走一路；勾选「多分支同时命中」则可并行出多条）。" })
      ] })
    }
  );
}
...
const WorkflowCanvas = reactExports.forwardRef(
  function WorkflowCanvas2({
    ...
    const rfNodesRef = reactExports.useRef(rfNodes);
    const rfEdgesRef = reactExports.useRef(rfEdges);
    ...
    const onNodesChange = reactExports.useCallback(
      (changes) => {
        ...
        const nextNodes = applyNodeChanges(filtered, rfNodesRef.current);
