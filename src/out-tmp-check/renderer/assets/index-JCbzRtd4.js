const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-Cim1CInR.js","./index-D2SMd1bE.js","./vendor-xyflow-SxuD-EZ_.css","./index-Z1iqQGn_.css","./index-DbNBeDpW.css"])))=>i.map(i=>d[i]);
import { y as querySessionType, ab as useAppStore, aj as useSessionStore, P as useSettingsStore, bB as useScheduleStore, aE as usePublishStore, aF as useWorkflowsStore, cK as useRulesStore, ck as queryAllProviderOptions, ax as RefIcon$1, cP as RefIcon$2, Z as queryModelLabel, aB as FeaturePageHeader, T as Typography, B as Button, aD as RefIcon$3, dj as RefIcon$4, aq as Tag, al as shellStyles, cv as RefIcon$5, aP as DB_THEME, aa as RefIcon$6, bo as RefIcon$8, af as RefIcon$9, O as RefIcon$a, A as __vitePreload } from "./index-D2SMd1bE.js";
import { r as reactExports, j as jsxRuntimeExports } from "./vendor-xyflow-C3K48oRM.js";
import { u as useSkillsStore } from "./useSkillsStore-Dhf-1X-q.js";
...
import { R as RefIcon } from "./RocketOutlined-jqRlO1q1.js";
import { R as RefIcon$7 } from "./ApartmentOutlined-CLSHNRkm.js";
const version = "0.1.8";
const appManifest = {
  version
};
...
const WorkbenchCharts = reactExports.lazy(
  () => __vitePreload(() => import("./index-Cim1CInR.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0, import.meta.url).then((m) => ({ default: m.WorkbenchCharts }))
);
const QUICK_ENTRIES = [
  {
    key: "chat",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(FeatureScrollBody, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: styles.section, "aria-label": "统计图表", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.sectionHead, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { type: "secondary", className: styles.sectionDesc, children: "基于本地会话数据聚合；Token 为 LLM 回调估算累计值" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
