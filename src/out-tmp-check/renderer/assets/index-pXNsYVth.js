...
import { u as useSkillsStore, i as isValidSkillId, s as slugifySkillId, q as queryProjectSkillDetail, c as skillDetailToInput, d as postRevealSkillDir } from "./useSkillsStore-Bec86d-P.js";
import { S as SkillMarkdown } from "./SkillMarkdown-B9mv4weK.js";
import { I as Icon, d as _extends, af as Form, aI as FeaturePageHeader, a6 as Space, E as Button, at as RefIcon$3, D as appMessage, aK as RefIcon$4, aa as RefIcon$5, ar as Segmented, as as shellStyles, ah as Input, aC as RefIcon$6, ab as Select, S as Spin, aw as Empty, aT as cardStyles, am as Card, T as Typography, ax as Tag, a5 as Tooltip, aF as RefIcon$7, aU as RefIcon$8, ag as Modal, aW as DB_THEME, aA as Popconfirm, aB as RefIcon$a, a_ as Switch, av as Drawer } from "./index-BQnnWLUu.js";
...
import { R as RefIcon$2 } from "./ExportOutlined-CqAonrgV.js";
import { R as RefIcon$9 } from "./FolderOpenOutlined-eU2RptIS.js";
...
function SkillStatusTag({ skill }) {
  if (skill.isBuiltin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: cardStyles.successTag, children: "已全局注入" });
  }
  if (!skill.enabled) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: cardStyles.warningTag, children: "未全局注入" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: cardStyles.successTag, children: "已全局注入" });
}
function SkillsPage() {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Spin, { spinning: detailLoading, children: !detail ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { description: "未找到技能详情" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailBody, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.detailHeader, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Space, { wrap: true, children: [
              ...
              detail.isBuiltin ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { type: "secondary", className: styles.injectLabel, children: "内置技能始终全局注入（不可关闭）" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.injectToggle, children: [
