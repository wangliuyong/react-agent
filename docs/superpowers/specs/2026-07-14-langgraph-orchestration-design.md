...
| supervisor | 无（或仅路由） |
| general | 全量 |
| researcher | fetch_hot_topics（weibo/baidu/douyin/kuaishou/tencent/tophub）, fetch_web_images, list_attachments, read_file, update_task_list, browser_navigate, browser_snapshot |
